...
This system allows storing user information such brazilian Cpf, first name, last name, birthday, cell phone number, home phone number etc, and also to store medical insurances.
...
The system allows registering a new patient, update an existing patient and delete it. The insurance is selected from all available insurances previously stored in the insurance table.
